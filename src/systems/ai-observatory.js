  ...
  class AIObservatory {
    ...
    squadSnapshot(squad) {
      ...
      return {
        ...
        tacticalMapId: squad.tacticalPoint?.tacticalMapId || "",
        tacticalMapKind: squad.tacticalPoint?.tacticalMapKind || "",
        tacticalRisk: Math.round(Number(squad.status?.tacticalRisk || squad.tacticalPoint?.tacticalRisk || 0) * 100) / 100,
        tacticalDangerZoneId: squad.status?.tacticalDangerZoneId || "",
    ...
    infantryState(unit) {
      ...
      return {
        ...
        commandState: debug.commandState || "",
        commandSource: debug.commandSource || "",
        commandReason: debug.commandReason || "",
        commandLockRemaining: debug.commandLockRemaining || 0,
        squadLeaderId: debug.squadLeaderId || "",
        commanderSlotId: debug.commanderSlotId || "",
        ...
        tacticalCoverNode: debug.tacticalCoverNode || "",
        tacticalMapKind: debug.tacticalMapKind || "",
        tacticalRisk: Math.round(Number(debug.tacticalRisk || 0) * 100) / 100,
        v2FailureReasons: Array.isArray(debug.v2FailureReasons) ? debug.v2FailureReasons.slice(0, 6) : [],
        v2RadioKind: debug.v2RadioKind || "",
        v2AssaultApproval: debug.v2AssaultApproval || "",
        v2Morale: debug.v2Morale || null,
        decision
      };
    }
    ...
    vehicleSnapshot(vehicle, type) {
      ...
      return {
        ...
        tacticalWaitForClear: debug.tacticalWaitForClear || "",
        tacticalVehicleStage: debug.tacticalVehicleStage || "",
