...
(function registerTank(global) {
  ...
  class Tank {
    ...
    fire(game, options = {}) {
      ...
      const tankFireSound = ammo.id === "he" ? "tank-fire-he" : ammo.id === "ap" ? "tank-fire-ap" : "tank-fire";
      IronLine.audio?.play?.(tankFireSound, { game, x: muzzleX, y: muzzleY, volume: ammo.id === "he" ? 0.95 : 0.82 });
